...
الحقيقة وراء الأحداث حدث في مثل هذا اليوم تم طلب موقع نساءي
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 hidden-xs">
                    <div class="thumbnail" style="height:250px; ">
                        <div class="down"> إتكلمي
                            ...
                            <img src="/images/pictures/e.png" class="img-thumbnail img-responsive " style="
    margin-left: auto;
    margin-right: auto;
    display: table-cell;
    vertical-align: middle ">
                        ...
                        <div class="caption">
                            <p style="text-align:center;font-size: 13px;font-family:elight;color: #001652;">
                ...
                <div class="col-lg-4 col-md-4 col-sm-4 hidden-xs ">
                    <div class="thumbnail" style="height:250px; ">
                        <div class="down"> دنيانا
                            <hr style="border-color:#000128!important; margin-top:0px!important;"/>
                            <img src="/images/pictures/d.png" class="img-thumbnail img-responsive" style="margin-left: auto;margin-right: auto;display: table-cell;vertical-align: middle">
                        </div>
                        <div class="caption">
    ...
    vertical-align: middle ">
        ...
        <div class="col-xs-12 hidden-sm col-md-3 col-lg-3    pull-left">
            <div class="row">
                <div class="col-md-12 col-sm-4 col-xs-12">
                    <div class="thumbnail" id="left">
                        <p class="header-name">
                            رأيك
                            ايه؟
                        <img src="/images/pictures/p.png" ></p>
    ...
    <div class="row"
        ...
        <footer>
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                ...
                <button style="padding:0px 0px;border:none; border-radius:3px;"><img
                    ...
                    <form class="form-inline" role="form" style="text-align:right; padding-top: 2%;">
                        <div class="form-group">
                            ...
                            <div class=" col-xs-8 col-sm-8 col-md-10 col-lg-10">
                                <input type="email" class="form-control" id="email-term">
                            </div>
                        </div>
                    </form>
